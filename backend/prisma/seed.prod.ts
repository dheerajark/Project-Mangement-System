...
export async function seedProduction(prisma: PrismaClient) {
  ...
  const auditorPerms = ['VIEW_PROJECT', 'VIEW_TASK', 'VIEW_ALL_TASKS', 'VIEW_ISSUE', 'VIEW_ALL_ISSUES', 'VIEW_MILESTONE', 'VIEW_ALL_MILESTONES', 'VIEW_REPORT'];
  ...
  const stakeholderPerms = ['VIEW_PROJECT', 'VIEW_MILESTONE', 'VIEW_ALL_MILESTONES', 'VIEW_REPORT'];
