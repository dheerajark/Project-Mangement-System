...
export class NotificationController {
  ...
  @Get('notifications')
  @ApiOperation({
    summary: 'Get all active notifications for the logged-in user',
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Mark all unread notifications of the user as read',
  })
  @ApiResponse({
    status: 200,
    description: 'All notifications marked as read.',
  })
  markAllAsRead(@TenantId() orgId: string, @GetCurrentUserId() userId: string) {
